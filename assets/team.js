/* =============================================================================
   ...
   Reads LABELS + SECTIONS from team-data.js. No dependencies.
   ========================================================================== */
(function () {
  "use strict";
  ...
  function openModal(m) {
    ...
    modal.querySelector(".modal__media").src = m.photo || placeholder(m.name);
